...
while True:
    ...
    # Adds items into inventory
        ...
        item_quantity = queue.push(user_input_quantity)
        item_costs = queue.push(user_input_costs)
    ...
    # Sells items from inventory
        ...
        queue.pop(item_quantity_to_sell)

        average_cost = int(costs * 1.1)
        profit += average_cost * item_quantity_to_sell

        queue.pop(costs)
        print("The average cost per item is: $" + str(average_cost))